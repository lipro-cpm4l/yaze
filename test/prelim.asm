...
;
; ZASM Z80 Macro Assembler	: zasm -uwy --z80 prelim.asm prelim.com
;

; prelim.azm - Preliminary Z80 tests
; Original Copyright (C) 1994  Frank D. Cringle
;
; Changes at 31-Oct-2017 Copyright (C) 2017 Stephan Linz
; + Source syntax tweeked to assemble with ZASM Z80 Macro Assembler
;   by Günter Woigk (kio), marked in the source with 'sli:'
;
...
lab1hi	equ	lab1 / 0100h	; sli: replace MACRO-80 syntax 'high lab1'
lab1lo	equ	lab1 & 0ffh	; sli: replace MACRO-80 syntax 'low lab1'
...
hextabhi equ	hextab / 0100h	; sli: replace MACRO-80 syntax 'high hextab'
hextablo equ	hextab & 0ffh	; sli: replace MACRO-80 syntax 'low hextab'
